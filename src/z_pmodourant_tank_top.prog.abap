...
TYPES : BEGIN OF ty_final,
          ...
          year_built    TYPE n LENGTH 4 ,
          thermal_relief_press TYPE n LENGTH 5,
          thermal_relief_press_uom TYPE atwrt,
          crn_number   TYPE atwrt,
          thermal_relief_ind TYPE atwrt,
          level_indicator_type TYPE atwrt,
...
DATA : ta_final   TYPE STANDARD TABLE OF ty_final,
       ...
       ta_status  TYPE STANDARD TABLE OF bapi_itob_status, "(+)PANUSURI Ticket ACR-4909
       ta_ustatus TYPE STANDARD TABLE OF bapi_itob_status, "(+)PANUSURI Ticket ACR-4909
